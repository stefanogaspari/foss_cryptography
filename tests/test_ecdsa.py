...
def test_non_deterministic_sign():
    ...
    if len(hex(r_sha256_sample_secp256r1)[2:]) % 2 == 0:
        len_r_bytes = len(hex(r_sha256_sample_secp256r1)[2:]) // 2
    else:
        len_r_bytes = len(hex(r_sha256_sample_secp256r1)[2:]) // 2 + 1
    if len(hex(s_sha256_sample_secp256r1)[2:]) % 2 == 0:
        len_s_bytes = len(hex(r_sha256_sample_secp256r1)[2:]) // 2
    else:
        len_s_bytes = len(hex(r_sha256_sample_secp256r1)[2:]) // 2 + 1
    if len(hex(x_sha256_sample_secp256r1)[2:]) % 2 == 0:
        len_x_bytes = len(hex(x_sha256_sample_secp256r1)[2:]) // 2
    else:
        len_x_bytes = len(hex(x_sha256_sample_secp256r1)[2:]) // 2 + 1
    ...
    assert ecdsa_test.non_deterministic_sign(k_sha256_sample_secp256r1, m_sha256_sample_secp256r1, x_vector)[0] == r_vector
    assert ecdsa_test.non_deterministic_sign(k_sha256_sample_secp256r1, m_sha256_sample_secp256r1, x_vector)[1] == s_vector
...
def test_deterministic_sign():
    ...
    s_vector = s_sha256_sample_secp256r1.to_bytes(len_s_bytes, byteorder='big')
    x_vector = x_sha256_sample_secp256r1.to_bytes(len_x_bytes, byteorder='big')
    assert ecdsa_test.deterministic_sign(m_sha256_sample_secp256r1, x_vector)[0] == r_vector
    assert ecdsa_test.deterministic_sign(m_sha256_sample_secp256r1, x_vector)[1] == s_vector
